...
Blacklight.onLoad(function() {
	...
	$('#new_user_name_skel').on('blur', verify_user_for_permission);

	// add button for new user
	$('#add_new_user_skel').on('click', add_user_permission);

	// add button for new group
	$('#add_new_group_skel').on('click', add_group_permission);
...
// Verify that user exists in the directory
function verify_user_for_permission {
...
// Add a permission for a user or group
